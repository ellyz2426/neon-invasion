...
export class AudioSystem extends createSystem({}) {
  ...
  playSound(name: string) {
    ...
    switch (name) {
      ...
      case 'killStreak': this.playMelody([880, 1100, 1320, 1760], 0.06, 'square', 0.18); this.tone(440, 0.15, 'sawtooth', 0.1, 0.2); break;
      case 'bossWarp': this.noise(0.3, 0.15); this.tone(100, 0.4, 'sine', 0.2); this.tone(150, 0.35, 'sine', 0.15, 0.15); break;
    }
  }
